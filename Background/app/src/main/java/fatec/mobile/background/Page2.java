    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonRed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int color = Color.rgb(245, 122, 212);
        ...
        buttonGreen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int color = Color.rgb(154, 72, 247);
                changeBackgroundColor(color);
                saveColorToPreferences(color);
            }
        });
        ...
        buttonBlue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int color = Color.rgb(247, 240, 92);
                changeBackgroundColor(color);
                saveColorToPreferences(color);
            }
        });
        ...
        protected void onResume(){
            super.onResume();
            int saveColor = getColorPreferences();
            changeBackgroundColor(saveColor);
        }

        public int getColorPreferences(){
            SharedPreferences preferences = getSharedPreferences("CorPreferences", MODE_PRIVATE);
